  ...
  data() {
    return {
      ...
      leftEntryList: [
        ...
        {
          title: '修炼及修炼炉',
          content: '对战席右侧有个八卦即为修炼炉，通过将己方手牌移至该处（该手牌即回进入该区域，只能通过特定的卡牌效果取回）可使己方修为和法力均+1，每回合一次（五庄观门派在7修及之后可以无修炼次数上线，但从第二张修炼卡开始不加法力）。',
        },
        {
          title: '门派',
        ...
        {
          title: '生灵牌',
          content: '可以通过放置在场上来进行进攻、生效、抵挡对峙生灵攻击。己方回合结束时并且生灵不是进场的回合，己方所有生灵会自动进行一轮攻击，若生灵所在场地格对面有敌方生灵则进攻生灵，没有则攻击敌方主角。敌方主角所扣血量为生灵攻击次数x生灵攻击力。',
        },
        {
          title: '装备牌',
